    ...
    <div className="bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center flex-col gap-3">
      ...
      >
        <div className="md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex flex-col gap-1 w-[85%] px-3">
            <label className="font-semibold">Email</label>
            <input
              type="text"
              className="border border-[#e7e6e6] h-[35px] px-[20px]"
          ...
          <div className="flex flex-col gap-1 w-[85%] px-3 relative">
            ...
            {!show ? (
              <MdOutlineRemoveRedEye
                className="absolute right-[5%] bottom-[10%] w-[20px] h-[20px] cursor-pointer"
        ...
        <div className="hidden md:flex w-[50%] h-[100%] bg-black rounded-r-2xl items-center justify-center flex-col">
